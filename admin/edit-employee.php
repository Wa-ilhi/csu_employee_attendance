...
$id = $_GET['id'];
$fetch_query = pg_query($connection, "SELECT * FROM tbl_employee WHERE id='$id'");
$row = pg_fetch_assoc($fetch_query);
...
if (isset($_REQUEST['save-emp'])) {
    ...
    $update_query = pg_query_params(
        $connection,
        "UPDATE tbl_employee SET first_name=$1, last_name=$2, username=$3, emailid=$4, password=$5, dob=$6, joining_date=$7, gender=$8, phone=$9, shift=$10, department=$11, status=$12 WHERE id=$13",
        array($first_name, $last_name, $username, $emailid, $pwd, $dob, $joining_date, $gender, $phone, $shift, $department, $status, $id)
    );
                    ...
                    <form method="post">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="shift" required>
                                        ...
                                        <?php
                                        $fetch_query = pg_query($connection, "SELECT start_time, end_time FROM tbl_shift");
                                        while ($shift = pg_fetch_assoc($fetch_query)) {
                                        ?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="department" required>
                                        <option value="">Select</option>
                                        <?php
                                        $fetch_query = pg_query($connection, "SELECT department_name FROM tbl_department");
                                        while ($dept = pg_fetch_assoc($fetch_query)) {
                                        ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="emp_active" value="1" <?php if ($row['status'] == 1) {
                                                                                                                            echo 'checked';
                                                                                                                        } ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="emp_inactive" value="0" <?php if ($row['status'] == 0) {
                                                                                                                            echo 'checked';
                                                                                                                        } ?>>
