...
if (isset($_REQUEST['login'])) {
    ...
    $fetch_query = pg_query_params($connection, "SELECT * FROM tbl_employee WHERE username = $1 AND password = $2 AND role = $3", array($username, $pwd, 1));
    $res = pg_num_rows($fetch_query);

    if ($res > 0) {
        $data = pg_fetch_array($fetch_query);
                ...
                <div class="account-box">
                    <form method="post" class="form-signin">
                        <div class="account-logo">
                            <h3>CSU Employee Attendance Management System</h3>
                        </div>
