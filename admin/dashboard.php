        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                <div class="dash-widget">
                    ...
                    <?php
                    $fetch_query = pg_query($connection, "select count(*) as total from tbl_employee where status='1' and role='0'");
                    $emp = pg_fetch_row($fetch_query);
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                <div class="dash-widget">
                    ...
                    <?php
                    $fetch_query = pg_query($connection, "select count(*) as total from tbl_department where status=1");
                    $dept = pg_fetch_row($fetch_query);
                    ?>
                    <div class="dash-widget-info text-right">
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                <div class="dash-widget">
                    ...
                    <?php
                    $fetch_query = pg_query($connection, "select count(*) as total from tbl_shift where status=1");
                    $shift = pg_fetch_row($fetch_query);
                    ?>
                    <div class="dash-widget-info text-right">
                    ...
                    <div class="card-block">
                        <div class="table-responsive">
                            <table class="table mb-0 new-patient-table">
                                <tbody>
                                    <?php
                                    $fetch_query = pg_query($connection, "select * from tbl_employee where role='0' limit 5");
                                    while ($row = pg_fetch_array($fetch_query)) {
                                        // Process each row
                                    ?>
                                        <tr>
                                            <td>
                ...
                <div class="card member-panel">
                    ...
                    <div class="card-body">
                        <ul class="contact-list">
                            <?php
                            $fetch_query = pg_query($connection, "select * from tbl_employee where status=1 and role='0' limit 5");
                            while ($row = pg_fetch_array($fetch_query)) {
                            ?>
                                <li>
