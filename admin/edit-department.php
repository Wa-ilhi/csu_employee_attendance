...
$id = $_GET['id'];
$fetch_query = pg_query($connection, "SELECT * FROM tbl_department WHERE id='$id'");
...
if (isset($_REQUEST['save-department'])) {
    ...
    $update_query = pg_query($connection, "UPDATE tbl_department SET department_id='$department_id', department_name='$department_name', status='$status' WHERE id='$id'");
    if ($update_query) {
