...
$id = $_GET['id'];
$fetch_query = pg_query($connection, "SELECT * FROM tbl_shift WHERE id='$id'");
...
if (isset($_REQUEST['save-shift'])) {
    ...
    $update_query = pg_query($connection, "UPDATE tbl_shift SET start_time='$start_time', end_time='$end_time', status='$status' WHERE id='$id'");
    if ($update_query > 0) {
